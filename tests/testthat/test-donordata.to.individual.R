context("donordata.to.individual")
...
laura <- donordata.to.individual(dnr = dnr, id = ids[1])
kevin <- donordata.to.individual(dnr = dnr, id = ids[6])
...
jurre <- donordata.to.individual(dnr = dnr, id = ids[1])
anouk <- donordata.to.individual(dnr = dnr, id = ids[6])
