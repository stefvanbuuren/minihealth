...
#'    and from should be done using \code{nlreferences::transform2z()} and
#'    \code{nlreferences::transform2y()}.}
#'    \item{\code{transform}:}{Name of the \code{nlreferences} transform function.}
