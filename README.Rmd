...
- Defines S4 classes `xyz`, `bse`, `individual` and `cabinet` for analysing individual growth data; 
...
The S4 class `xyz` stores three variables useful for anthropemetric data: 
...
[clopus](https://github.com/stefvanbuuren/clopus) package for more examples.
...
[brokenstick](https://github.com/stefvanbuuren/brokenstick) package for more examples.
...
- `as(d1, "data.frame")` extracts the data frame from objects of class `xyz`;
